...
export default {
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u6587\u4EF6\u7CFB\u7EDF\u4E8B\u4EF6"),
    ...
    'updated': null,
    'excerpt': "轮询文件系统事件： const watcher = Deno.watchFs(\"/\"); for await (const event of watcher) { console.log(\">>>> event\", event); // { kind: \"create\", paths: [ \"/foo.txt\" ] } } 请注意，事件的确切顺序可能因操作系统而...",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
