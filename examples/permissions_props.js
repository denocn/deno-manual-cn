...
export default {
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u68C0\u67E5\u4E0E\u653E\u5F03\u6743\u9650"),
    ...
    'updated': null,
    'excerpt': "有时一个程序会放弃之前获得的权限，在此之后，需要该权限的操作将失败。 // 查找一个权限 const status = await Deno.permissions.query({ name: \"write\" }); if (status.state !== \"granted\") { throw new Error(\"need write...",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
