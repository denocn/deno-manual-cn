...
export default {
    ...
    'content': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<h1>测试当前文件是否为主程序</h1>\n<p>当前脚本作为主程序的标志是 <code>import.meta.main</code>。</p>\n<pre class="language-ts"><code class="language-ts"><span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token keyword">import</span><span class="token punctuation">.</span>meta<span class="token punctuation">.</span>main<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">"main"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span>\n</code></pre>'
        } }),
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u6D4B\u8BD5\u5F53\u524D\u6587\u4EF6\u662F\u5426\u4E3A\u4E3B\u7A0B\u5E8F"),
    'contentBody': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<p>当前脚本作为主程序的标志是 <code>import.meta.main</code>。</p>\n<pre class="language-ts"><code class="language-ts"><span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token keyword">import</span><span class="token punctuation">.</span>meta<span class="token punctuation">.</span>main<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">"main"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span>\n</code></pre>'
        } }),
    'toc': null,
    'author': "迷渡",
    'contributors': [
    ...
    'updated': null,
    'excerpt': "当前脚本作为主程序的标志是 import.meta.main。 if (import.meta.main) { console.log(\"main\"); } ",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
