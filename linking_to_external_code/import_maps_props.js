...
export default {
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u5BFC\u5165\u6620\u5C04\uFF08Import maps\uFF09"),
    ...
    'updated': null,
    'excerpt': "Deno 支持 导入映射。 您可以通过 --importmap=<FILE> 的命令行选项使用导入映射。 目前的限制: - 只支持单个导入映射 - 没有 fallback URL - Deno 不支持 std: 命名空间 - 仅支持 file:，http: 和 https: 协议 示例： import_...",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
