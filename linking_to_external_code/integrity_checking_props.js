...
export default {
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u5B8C\u6574\u6027\u68C0\u67E5\u4E0E\u9501\u5B9A\u6587\u4EF6"),
    ...
    'updated': null,
    'excerpt': "介绍 假设您的模块依赖于远程模块 https://some.url/a.ts。当第一次编译您的模块时，a.ts 被下载、编译、缓存。它将保持这样，直到您在一个新的机器上运行您的模块（生产环境？）或是重新加载缓存（例如通过 deno cache --relo...",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
