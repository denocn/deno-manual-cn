...
export default {
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u91CD\u65B0\u52A0\u8F7D\u7279\u5B9A\u7684\u6A21\u5757"),
    'contentBody': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<p>默认情况下，缓存中的模块将被重用，而无需获取或重新编译它。有时这不是期望的行为，您可以强制 deno 重新下载模块并重新编译到缓存中。您可以使用 <code>deno cache</code> 子命令的<code>--reload</code> 选项来使本地 <code>DENO_DIR</code> 缓存无效。</p>\n<p>其用法描述如下：</p>\n<h2 id="%E9%87%8D%E6%96%B0%E5%8A%A0%E8%BD%BD%E6%89%80%E6%9C%89%E5%86%85%E5%AE%B9">重新加载所有内容<a class="anchor" href="#%E9%87%8D%E6%96%B0%E5%8A%A0%E8%BD%BD%E6%89%80%E6%9C%89%E5%86%85%E5%AE%B9">§</a></h2>\n<pre class="language-ts"><code class="language-ts">deno cache <span class="token operator">--</span>reload my_module<span class="token punctuation">.</span>ts\n</code></pre>\n<h2 id="%E9%87%8D%E6%96%B0%E5%8A%A0%E8%BD%BD%E6%8C%87%E5%AE%9A%E6%A8%A1%E5%9D%97">重新加载指定模块<a class="anchor" href="#%E9%87%8D%E6%96%B0%E5%8A%A0%E8%BD%BD%E6%8C%87%E5%AE%9A%E6%A8%A1%E5%9D%97">§</a></h2>\n<p>有时我们只想升级某些模块，可以通过将参数传递给 <code>--reload</code> 选项来控制它。</p>\n<p>重新加载所有 v0.55.0 的标准模块：</p>\n<pre class="language-ts"><code class="language-ts">deno cache <span class="token operator">--</span>reload<span class="token operator">=</span>https<span class="token operator">:</span><span class="token operator">/</span><span class="token operator">/</span>deno<span class="token punctuation">.</span>land<span class="token operator">/</span>std@v0<span class="token punctuation">.</span><span class="token number">55.0</span> my_module<span class="token punctuation">.</span>ts\n</code></pre>\n<p>为了重新加载特定的模块（在这个例子中是 colors 和 file system copy），需要使用逗号来分隔 URL：</p>\n<pre class="language-ts"><code class="language-ts">deno cache <span class="token operator">--</span>reload<span class="token operator">=</span>https<span class="token operator">:</span><span class="token operator">/</span><span class="token operator">/</span>deno<span class="token punctuation">.</span>land<span class="token operator">/</span>std<span class="token operator">/</span>fs<span class="token operator">/</span>copy<span class="token punctuation">.</span>ts<span class="token punctuation">,</span>https<span class="token operator">:</span><span class="token operator">/</span><span class="token operator">/</span>deno<span class="token punctuation">.</span>land<span class="token operator">/</span>std<span class="token operator">/</span>fmt<span class="token operator">/</span>colors<span class="token punctuation">.</span>ts my_module<span class="token punctuation">.</span>ts\n</code></pre>\n<!-- Should this be part of examples? -->'
        } }),
    ...
    'updated': null,
    'excerpt': "默认情况下，缓存中的模块将被重用，而无需获取或重新编译它。有时这不是期望的行为，您可以强制 deno 重新下载模块并重新编译到缓存中。您可以使用 deno cache 子命令的--reload 选项来使本地 DENO_DIR 缓存无效。 其用法描述...",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
