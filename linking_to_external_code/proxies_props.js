...
export default {
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u4EE3\u7406\uFF08Proxies\uFF09"),
    'contentBody': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<p>Deno 支持模块下载和 Web 标准 <code>fetch</code> API 的代理。</p>\n<p>代理配置从环境变量中读取: <code>HTTP_PROXY</code> 和 <code>HTTPS_PROXY</code>。</p>\n<p>在 Windows 的环境下，如果没有发现环境变量，Deno 会从注册表中读取代理。</p>'
        } }),
    'toc': null,
    'author': "迷渡",
    'contributors': [
    ...
    'updated': null,
    'excerpt': "Deno 支持模块下载和 Web 标准 fetch API 的代理。 代理配置从环境变量中读取: HTTP_PROXY 和 HTTPS_PROXY。 在 Windows 的环境下，如果没有发现环境变量，Deno 会从注册表中读取代理。",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
