...
export default {
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u5D4C\u5165\u5F0F Deno"),
    'contentBody': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<p>Deno 由多个部分组成，其中之一是 <code>deno_core</code>。这是一个 rust\ncrate，可以用作 Rust 应用中的嵌入式 JavaScript 运行时。</p>\n<p>Deno 建立在 <code>deno_core</code> 的基础上。</p>\n<p>Deno crate 发布于 <a href="https://crates.io/crates/deno_core">crates.io</a>。</p>\n<p>您可以通过 <a href="https://docs.rs/deno_core">docs.rs</a> 查阅其 API。</p>\n<!-- TODO(lucacasonato): better docs -->'
        } }),
    'toc': null,
    'author': "迷渡",
    'contributors': [
    ...
    'updated': null,
    'excerpt': "Deno 由多个部分组成，其中之一是 deno_core。这是一个 rust crate，可以用作 Rust 应用中的嵌入式 JavaScript 运行时。 Deno 建立在 deno_core 的基础上。 Deno crate 发布于 crates.io。 您可以通过 docs.rs 查阅其 API。",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
