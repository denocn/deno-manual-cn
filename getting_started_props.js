...
export default {
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u5165\u95E8"),
    'contentBody': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<p>在本章节，我们将讨论；</p>\n<ul>\n<li>安装 Deno</li>\n<li>设置您的环境</li>\n<li>运行一个 <code>Hello World</code> 脚本</li>\n<li>编写您自己的脚本</li>\n<li>命令行界面</li>\n<li>理解权限控制</li>\n<li>在 Deno 中使用 TypeScript</li>\n<li>在 Deno 中使用 WebAssembly</li>\n</ul>'
        } }),
    'toc': null,
    'author': "迷渡",
    'contributors': [
    ...
    'updated': null,
    'excerpt': "在本章节，我们将讨论； - 安装 Deno - 设置您的环境 - 运行一个 Hello World 脚本 - 编写您自己的脚本 - 命令行界面 - 理解权限控制 - 在 Deno 中使用 TypeScript - 在 Deno 中使用 WebAssembly",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
