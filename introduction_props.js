...
export default {
    ...
    'updated': null,
    'excerpt': "Deno 是一个 JavaScript/TypeScript 的运行时，默认使用安全环境执行代码，有着卓越的开发体验。 Deno 建立在 V8、Rust 和 Tokio 的基础上。 功能亮点 - 默认安全。外部代码没有文件系统、网络、环境的访问权限，除非显式开启。...",
    'cover': undefined,
    'sidebar': [
        {
            "title": "Deno 中文手册",
